...
<label>
  <input type="checkbox" v-model="value" :autocomplete="schema.autocomplete" :disabled="disabled" :name="schema.inputName" :id="getFieldID(schema)"><span class="label" :data-on="schema.textOn || 'On'" :data-off="schema.textOff || 'Off'" :for="getFieldID(schema)"></span><span class="handle"></span>
</label>
</template>
